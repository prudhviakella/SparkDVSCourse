...
object ItemWiseDiscount {
  ...
  def main(args: Array[String]) {
    ...
    conf.set("spark.eventLog.dir", "/home/cloudera/projects/spark-core/src/main/resources/sparkhistoryserverlogs")
    val sc = new SparkContext(conf)
    //val dataRDD = sc.textFile("/home/cloudera/projects/spark-core/src/main/resources/sales.csv")
    val dataRDD = sc.textFile("hdfs://quickstart.cloudera:8020/user/cloudera/csvdata/sales.csv")
